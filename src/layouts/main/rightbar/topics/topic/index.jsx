  ...
  return (
    ...
    >
      ...
      <Popover className="absolute top-1.5 right-2">
        ...
        <Popover.Panel className="w-[384px] rounded-xl grid absolute top-2 overflow-hidden right-0 bg-[color:var(--background-primary)] shadow-box z-[2]">
