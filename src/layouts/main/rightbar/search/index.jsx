...
export default function Search() {
	...
	return (
		...
		>
			<label className="h-[2.688rem] rounded-full bg-[color:var(--background-third)] w-full relative group border border-transparent focus-within:bg-black focus-within:border-[color:var(--color-primary)]">
