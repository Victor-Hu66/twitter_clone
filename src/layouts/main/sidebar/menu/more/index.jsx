...
export default function More() {
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 bg-[color:var(--background-primary)]  shadow-box rounded-xl">
        <buton className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 group-hover:bg-[color:var(--background-secondary)] overflow-hidden">
          <div className="w-[1.641rem] h-[1.641rem] relative">
