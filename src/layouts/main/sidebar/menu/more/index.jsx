...
export default function More() {
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 bg-black shadow-box rounded-xl">
        <buton className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 group-hover:bg-[#eff3f41a] overflow-hidden">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
              <path
                fill="#e7e9ea"
