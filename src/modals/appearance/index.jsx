					...
					<div className="border border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl">
						...
						<div className="flex-1 flex flex-col">
							...
							At the heart of X are short messages called posts — just like this one — which can include photos, videos, links, text, hashtags, and mentions like 
							 <Link className="text-[#1d9bf0] hover:underline" to="/x">@X</Link> 
							</div>
						</div>
					</div>
				</div>
				...
				<div className="grid gap-3">
					...
					<section>
						...
						<div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
							...
							>
								<div
									className="w-10 h-10 rounded-full flex-shrink-0 group-hover:bg-black/5 flex items-center justify-center">
									<div
							...
							>
								<div
									className="w-10 h-10 rounded-full flex-shrink-0 group-hover:bg-white/5 flex items-center justify-center">
									<div
							...
							>
								<div
									className="w-10 h-10 rounded-full flex-shrink-0 group-hover:bg-white/10 flex items-center justify-center">
									<div
